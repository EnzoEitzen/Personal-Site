...
const LainCarousel = () => {
    return (
        <div className="mb-32 flex flex-col place-items-center text-center lg:max-w-5xl lg:w-full lg:mb-5 lg:text-left">
            <Carousel className={"size-1/2 sm:size-1/3 md:size-1/3 lg:size-1/5"} opts={{ loop: true }}>
                <CarouselContent>
                    <CarouselItem>
                        <Image src={"/images/676c1cf8-2657-43a6-bed0-83d3a84ec435.jpg"} alt={"Lain"} width={300} height={300} />
                    </CarouselItem>
                    <CarouselItem>

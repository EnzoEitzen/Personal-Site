...
export default function Home() {
    return (<main className="flex min-h-screen flex-col items-center justify-between p-24">
        ...
        <div className="flex flex-col place-items-center mb-32 text-center lg:max-w-5xl lg:w-full lg:mb-5 lg:text-left">
            ...
            <p className="text-lg italic hover:not-italic text-center">I am a high school student, planning to study
                computer science. <br/> I mainly like
                back end dev and IOT dev.
                <br/> I currently live in Portugal.
            </p>
        </div>
